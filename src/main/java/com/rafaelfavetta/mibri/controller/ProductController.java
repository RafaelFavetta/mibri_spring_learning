...
import com.rafaelfavetta.mibri.dto.ProductRecordDto;
...
public class ProductController {
    ...
    public ResponseEntity<Object> getProductById(@PathVariable UUID id) {
        ...
        return productO.<ResponseEntity<Object>>map(productModel -> ResponseEntity.status(HttpStatus.OK)
                .body(productModel)).orElseGet(() -> ResponseEntity.status(HttpStatus.NOT_FOUND)
